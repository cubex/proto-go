...
type HTTPRequest struct {
	...
	RequestType HTTPRequest_RequestType               `protobuf:"varint,8,opt,name=request_type,json=requestType,enum=applications.HTTPRequest_RequestType" json:"request_type,omitempty"`
}
...
type SocketRequest struct {
	...
	Action   SocketAction `protobuf:"varint,2,opt,name=action,enum=applications.SocketAction" json:"action,omitempty"`
...
type ProjectModifyRequest struct {
	...
	Mode      ProjectModifyRequest_ModifyMode `protobuf:"varint,2,opt,name=mode,enum=applications.ProjectModifyRequest_ModifyMode" json:"mode,omitempty"`
...
func init() {
	proto.RegisterType((*HTTPRequest)(nil), "applications.HTTPRequest")
	proto.RegisterType((*HTTPRequest_HTTPParameter)(nil), "applications.HTTPRequest.HTTPParameter")
	proto.RegisterType((*HTTPResponse)(nil), "applications.HTTPResponse")
	proto.RegisterType((*HTTPResponse_HTTPHeaderParameter)(nil), "applications.HTTPResponse.HTTPHeaderParameter")
	proto.RegisterType((*SocketRequest)(nil), "applications.SocketRequest")
	proto.RegisterType((*ProjectModifyRequest)(nil), "applications.ProjectModifyRequest")
	proto.RegisterType((*ProjectModifyResponse)(nil), "applications.ProjectModifyResponse")
	proto.RegisterEnum("applications.SocketAction", SocketAction_name, SocketAction_value)
	proto.RegisterEnum("applications.HTTPRequest_RequestType", HTTPRequest_RequestType_name, HTTPRequest_RequestType_value)
	proto.RegisterEnum("applications.ProjectModifyRequest_ModifyMode", ProjectModifyRequest_ModifyMode_name, ProjectModifyRequest_ModifyMode_value)
}
...
func (c *applicationClient) HandleHTTPRequest(ctx context.Context, in *HTTPRequest, opts ...grpc.CallOption) (*HTTPResponse, error) {
	...
	err := grpc.Invoke(ctx, "/applications.Application/HandleHTTPRequest", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *applicationClient) HandleSocketAction(ctx context.Context, in *SocketRequest, opts ...grpc.CallOption) (*HTTPResponse, error) {
	out := new(HTTPResponse)
	err := grpc.Invoke(ctx, "/applications.Application/HandleSocketAction", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *applicationClient) ModifyRelationship(ctx context.Context, in *ProjectModifyRequest, opts ...grpc.CallOption) (*ProjectModifyResponse, error) {
	...
	err := grpc.Invoke(ctx, "/applications.Application/ModifyRelationship", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Application_HandleHTTPRequest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/applications.Application/HandleHTTPRequest",
	}
...
func _Application_HandleSocketAction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/applications.Application/HandleSocketAction",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Application_ModifyRelationship_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/applications.Application/ModifyRelationship",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Application_serviceDesc = grpc.ServiceDesc{
	ServiceName: "applications.Application",
...
func init() { proto.RegisterFile("applications.proto", fileDescriptor0) }

var fileDescriptor0 = []byte{
	// 796 bytes of a gzipped FileDescriptorProto
	,
}
